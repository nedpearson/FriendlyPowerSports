...
export const INVENTORY = [
  ...
  { id: 'INV-1005', stock: 'U8845', vin: 'JYAB123456789', brandId: 'BR-1', model: 'MT-07', year: 2021, category: 'Motorcycle', condition: 'Used', locationId: 'LOC-3', cost: 5100, price: null, reconSpend: 340, ageDays: 8, fpCostPerDay: 0, status: 'Recon', techId: 'EMP-7' },
  { id: 'INV-1006', stock: 'U8846', vin: 'JHMB123456789', brandId: 'BR-2', model: 'Rebel 500', year: 2019, category: 'Motorcycle', condition: 'Used', locationId: 'LOC-3', cost: 3200, price: null, reconSpend: 0, ageDays: 2, fpCostPerDay: 0, status: 'Inspection', techId: 'EMP-6' },
  { id: 'INV-1007', stock: 'U8847', vin: '3B1123456789', brandId: 'BR-3', model: 'Ranger 1000', year: 2020, category: 'SxS', condition: 'Used', locationId: 'LOC-3', cost: 8400, price: null, reconSpend: 1100, ageDays: 14, fpCostPerDay: 0, status: 'Recon', techId: 'EMP-6' },
  { id: 'INV-1008', stock: 'U8848', vin: 'JKAB123456789', brandId: 'BR-4', model: 'Z900', year: 2022, category: 'Motorcycle', condition: 'Used', locationId: 'LOC-3', cost: 6200, price: null, reconSpend: 85, ageDays: 18, fpCostPerDay: 0, status: 'Detail', techId: 'EMP-7' },
  { id: 'INV-1009', stock: 'U8849', vin: 'JYAC123456789', brandId: 'BR-1', model: 'Wolverine RMAX2', year: 2021, category: 'SxS', condition: 'Used', locationId: 'LOC-3', cost: 14500, price: null, reconSpend: 1840, ageDays: 28, fpCostPerDay: 0, status: 'Detail', techId: 'EMP-6' },
  { id: 'INV-1010', stock: 'U8850', vin: 'JHMC123456789', brandId: 'BR-2', model: 'Pioneer 1000-5', year: 2018, category: 'SxS', condition: 'Used', locationId: 'LOC-3', cost: 9800, price: 12999, reconSpend: 800, ageDays: 32, fpCostPerDay: 0, status: 'Frontline' },
  { id: 'INV-1011', stock: 'U8851', vin: 'JKAC123456789', brandId: 'BR-4', model: 'KLX 300', year: 2023, category: 'Motorcycle', condition: 'Used', locationId: 'LOC-3', cost: 4100, price: 5499, reconSpend: 120, ageDays: 6, fpCostPerDay: 0, status: 'Frontline' },
  { id: 'INV-1012', stock: 'U8852', vin: '3C1123456789', brandId: 'BR-3', model: 'Sportsman 570', year: 2015, category: 'ATV', condition: 'Used', locationId: 'LOC-3', cost: 1800, price: null, reconSpend: 0, ageDays: 1, fpCostPerDay: 0, status: 'Inspection', techId: 'EMP-7' }
];
